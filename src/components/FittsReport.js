        ...
        if (this.props.totalClickEntries.length === 0) {
            ...
            return (
                <div className="centerWithinMe">
                    ...
                    <h5 className="stylish-heading centerWithinMe">Application of Fitts's Law</h5>
                    <p className="desc">According to Fitts's Law, the time it takes to move your cursor from one tile to another is a function of the distance between them.
